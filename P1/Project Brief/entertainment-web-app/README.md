...
Want some support on the challenge? [Join our Discord community](http://discord.grammerhub.org) and ask questions in the **#codereview** channel.

## Where to find everything

Your task is to build out the project to the design file provided. We provide Figma version of the design. The design download comes with a `README.md` file as well to help you get set up.
